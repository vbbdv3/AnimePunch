...
local main = libary:CreateWindow("Anime Punch V1.6")
...
local mod = main:Button("Rank_Ascension_Potions", function()
loadstring(game:HttpGet('https://raw.githubusercontent.com/vbbdv3/AnimePunch/main/Rank_Ascension_Potions'))()
end)
...
local mod = main:Button("EvolvedMeliedes", function()
loadstring(game:HttpGet('https://raw.githubusercontent.com/vbbdv3/AnimePunch/main/EvolvedMeliedes'))()
end)

local mod = main:Button("Dungeon", function()
loadstring(game:HttpGet('https://raw.githubusercontent.com/vbbdv3/AnimePunch/main/Dungeon'))()
end)

local mod = main:Button("TrialEasy", function()
loadstring(game:HttpGet('https://raw.githubusercontent.com/vbbdv3/AnimePunch/main/TrialEasy'))()
end)
